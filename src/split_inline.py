...
def split_nodes_delimiter(old_nodes, delimiter, text_type):
    """
    old_nodes - List of an old node (TextNode)
    delimiter - The delimiter, which should split the old_nodes
    text_type - the text type we are looking for (delimiter = text_type)
    """
    new_nodes = []
